             ...
             {featuredCategories.map((cat, idx) => (
               ...
               >
                  ...
                  <div className="p-8">
                     ...
                     <Link href={cat.link} className="inline-flex items-center gap-2 text-primary text-[10px] uppercase tracking-[0.2em] font-black group-hover:translate-x-2 transition-transform">
