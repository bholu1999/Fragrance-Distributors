    ...
    <div className="bg-white pt-24">
      ...
      <section className="py-24 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative z-10 border border-slate-200 p-16 bg-white">
           ...
           <Link href="/contact" className="border-b border-slate-200 pb-1 text-[10px] font-bold text-slate-600 uppercase tracking-[0.2em] hover:border-primary hover:text-primary transition-all">Contact our wholesale team &rarr;</Link>
        </div>
      </section>
