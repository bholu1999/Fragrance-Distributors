  ...
  if (!product) {
    return (
      <div className="pt-32 pb-20 text-center min-h-screen bg-white">
        ...
        <Link to="/catalog" className="text-primary uppercase tracking-widest text-[10px] font-bold hover:underline">
          Return to Catalog
        </Link>
      </div>
    );
  ...
  return (
    <div className="bg-white pt-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
        ...
        <div className="mb-8">
          <Link to="/catalog" className="text-slate-500 hover:text-primary text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
