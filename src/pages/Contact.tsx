          ...
          >
              ...
              <div className="space-y-8 font-light text-slate-600 text-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p>128 Rue du Faubourg Saint-Honoré<br/>75008 Paris, France</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p>wholesale@auraessence.com<br/>partners@auraessence.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] mb-2 text-primary">Phone</h3>
                    <p>+33 1 42 68 53 00 (EU)<br/>+1 212 555 0198 (US)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 md:mt-0 aspect-video bg-white border border-slate-200 relative overflow-hidden group">
               ...
               <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                 <div className="w-4 h-4 bg-primary rounded-full shadow-[0_0_0_8px_rgba(197,160,89,0.3)] animate-pulse"></div>
               </div>
            </div>
