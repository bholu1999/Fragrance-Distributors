    ...
    <footer className="bg-dark text-slate-300 py-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          <Link to="/" className="text-xl font-sans font-bold tracking-tight uppercase flex items-center gap-1.5 mb-6 text-white">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/about" className="text-slate-400 hover:text-primary text-sm transition-colors">Our Infrastructure</Link></li>
            <li><Link to="/catalog" className="text-slate-400 hover:text-primary text-sm transition-colors">Digital Catalog</Link></li>
            <li><Link to="/download" className="text-slate-400 hover:text-primary text-sm transition-colors">Excel Download</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/contact" className="text-slate-400 hover:text-primary text-sm transition-colors">Investors</Link></li>
          </ul>
        </div>
